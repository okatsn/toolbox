...
% function [outputArg1,outputArg2] = WinDiagnostic(inputArg1,inputArg2)
% conv2GB = 1024^-3;
% Usage = System.Diagnostics.Process.GetCurrentProcess();
% totalMemory = Usage.VirtualMemorySize64*conv2GB;
% usedMemory = Usage.PagedSystemMemorySize64*conv2GB;
% 
% end
% 
% function mon = createMonitor
