function [ h ] = circles3(x,y,z,r,varargin)
warning("circles3 so far supports only plotting circles on a Z plane (20191027,Hsi)");
% https://people.sc.fsu.edu/~jburkardt/m_src/circles/circles.m
% https://people.sc.fsu.edu/~jburkardt/m_src/circles/circles.html
%
...
%     h(n) = fill ( ...
    h(n) = fill3( ...
      ...
      z.*ones(size(t)),... 
      '', ...
     varargin{:} ); % This version support only plot circle on the Z plane (20191027)
end
%
