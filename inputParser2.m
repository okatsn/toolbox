...
function_varargin2(noncharidx) = {tempString};
...
if nargout>1 %then restore
    restoreIdx = cellfun(@(x) strcmpi(x,tempString),function_varargin2);
    function_varargin2(restoreIdx) = function_varargin2_restore;
end
